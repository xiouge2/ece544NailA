...
class GoogleNetCuda(nn.Module):

    def __init__(self):
        super(GoogleNetCuda, self).__init__()
        ...
        self.avg_pool_out_4a=nn.AvgPool2d(3,stride=1);
        self.conv1_1_avg_pool_4a=nn.Conv2d(512,512,1,padding=0)
        self.fc1_4a=nn.Linear(6*2*512,512);
        self.fc2_4a=nn.Dropout(p=0.7);
        self.fc3_4a=nn.Linear(512,5);
    ...
    def concatenate(self,input1,input2,input3,input4):
        ...
        image_height=input1.size()[2];
        image_width=input1.size()[3];
        input_resize1=input1.view(50,-1)
        input_resize2=input2.view(50,-1)
        input_resize3=input3.view(50,-1)
        input_resize4=input4.view(50,-1)
        result=torch.cat([input_resize1,input_resize2,input_resize3,input_resize4],dim=1).view(50,-1,image_height,image_width);
        #print(result.size());
        return result
